...
bool GonzaloSanchez(char * cadena, size_t espacio) {
    static const struct alumno_s ALUMNO = {
        .apellidos = "SANCHEZ",
        .nombres = "Gonzalo",
        .documento = "31.250.903",
    };

    return SerializarAlumno(cadena, espacio, &ALUMNO);
}

bool GermanCardozo(char * cadena, size_t espacio) {
    const struct alumno_s alumno = {
        .apellidos = "CARDOZO",
        .nombres = "Germán Eloy",
...
bool FernandoTajes(char * cadena, size_t espacio) {
    const struct alumno_s alumno = {
        .apellidos = "Tajes",
        .nombres = "Fernando",
